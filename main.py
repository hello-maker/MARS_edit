...
if __name__ == '__main__':
    ...
    #parser.add_argument('--objectives', type=str,   default='gsk3b,jnk3,qed,sa')  # origin
    #parser.add_argument('--objectives', type=str,   default='Bcl-2,Bcl-xl,qed,sa')
    parser.add_argument('--objectives', type=str,   default='Bcl-2,Bcl-xl,Bcl-w')
    #parser.add_argument('--objectives', type=str,   default='Bcl-2,Bcl-xl,qed')
    parser.add_argument('--score_wght', type=str,   default='  1.0, 1.0, 1.0')
    parser.add_argument('--score_succ', type=str,   default='  0.0, 0.0, 0.0')
    parser.add_argument('--score_clip', type=str,   default='  100.0, 100.0, 100.0') #  
    #parser.add_argument('--score_wght', type=str,   default='  1.0, 1.0, 1.0')
    #parser.add_argument('--score_succ', type=str,   default='  0.8, 0.8, 0.8')
    #parser.add_argument('--score_clip', type=str,   default='  0.8, 0.8, 0.8')    
    
    
    #parser.add_argument('--score_wght', type=str,   default='  1.0, 1.0, 1.0') # 건들필요 x 
    #parser.add_argument('--score_succ', type=str,   default='  0.5, 0.5, 0.6') # 
     
    #parser.add_argument('--score_clip', type=str,   default='  0.6, 0.6, 0.7')    
